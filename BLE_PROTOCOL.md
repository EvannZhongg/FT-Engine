...
设备名称格式为前缀加 MAC 地址后两位，方便在多设备环境中区分。
...
| **Characteristic** | `025018d0-6951-4a81-de4f-453d8dae9128` | Read, Notify | **核心数据通道** |

> **注意**: 该特征值支持 **Notify** 属性。建议客户端连接后立即订阅 (Subscribe) 该特征值的通知，以便实时获取按键事件。
